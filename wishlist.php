											...
											<div class="custom_dropdown_list">
												...
												<ul class="custom_list clc">
													<?php
														...
														while ($row = mysqli_fetch_assoc($req)) {
															echo "
															<li><a class='clc' href='#'>$row[name_categorie]</a></li>
															";
														}
													?>
													<!-- if you wanna add some pictures to the search engine in categories .. -->
													<!-- <li><a class="clc" href="#"> <img src="images/adv_3.png" width="20px" height="20px"> All Categories</a></li> -->
												</ul>
											</div>
										</div>
					...
					<div class="cart_container">
						...
						<div class="cart_items">
							<ul class="cart_list">
								<?php
									if(isset($_SESSION['user_in'])){
										$sql = "SELECT * FROM wishlist,product WHERE wishlist.id_user = $_SESSION[user_in] AND wishlist.id_product = product.id_product";
										$req = mysqli_query($conn, $sql);

										while ($row = mysqli_fetch_assoc($req)) {
											$w_price = $row['prix_fix']*$row['quantity'];
											echo "
											<li class='cart_item clearfix'>
												...
												<div class='cart_item_info d-flex flex-md-row flex-column justify-content-between'>
													...
													<div class='cart_item_color cart_info_col'>
														...
														<div class='cart_item_text'><span style='background-color:$row[code_color];'></span>$row[color]</div>
													</div>
													...
													<div class='cart_item_price cart_info_col'>
														...
														<div class='cart_item_text'>$w_price</div>
													</div>
												</div>
											</li>												
											";
